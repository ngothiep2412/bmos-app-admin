...
const SelectComponentMorning = ({
  setVisibleMorning,
  listproductMealsMorning,
  setListProductMealsMorning,
  products = [],
}) => {
  const selectProductforyHandler = (item) => {
    const newList = [...listproductMealsMorning];
    ...
    setListProductMealsMorning(newList);

    setVisibleMorning(false);
  };
  ...
  return (
    <View style={styles.selectContainer}>
      <TouchableOpacity onPress={() => setVisibleMorning(false)}>
        <Avatar.Icon
          size={30}
...
export default SelectComponentMorning;
