...
const SelectComponentAfternoon = ({
  setVisibleAfternoon,
  listproductMealsAfternoon,
  setListProductMealsAfternoon,
  products = [],
}) => {
  const selectProductforyHandler = (item) => {
    const newList = [...listproductMealsAfternoon];
    ...
    setListProductMealsAfternoon(newList);

    setVisibleAfternoon(false);
  };
  ...
  return (
    <View style={styles.selectContainer}>
      <TouchableOpacity onPress={() => setVisibleAfternoon(false)}>
        <Avatar.Icon
          size={30}
...
export default SelectComponentAfternoon;
